					<div class="post">
						...
						<div class="entry">
                            ...
                            echo form_open('productos/submit_nuevo', $atributos);
                            ?>
                            <p>
...
<td class="tablatd"><input name="ean" id="ean" type="number" size="13" maxlength="13">  
<tr>
<td class="tablatd">Descripcion:
<td class="tablatd"><input name="descripcion" id="descripcion" type="text" size="60" maxlength="100">
<tr>
<td class="tablatd">Agrupamiento:
<td class="tablatd"><input name="grupo" id="grupo" type="number" size="2" maxlength="1">
<tr>
...
<td class="tablatd"><input name="eanalt" id="eanalt" type="number" size="13" maxlength="13">  
<tr>
<td class="tablatd">Descripcion Regalo:
<td class="tablatd"><input name="descripcionalt" id="descripcionalt" type="text" size="60" maxlength="100">

    </table>
</p>
							<br /><br /><p align="right"><input type="submit" id="nuevo-submit" value="AGREGAR" /></p>
                            <?php echo form_close(); ?>
						</div>
					</div>
